...
public class MyGridAdapter extends ArrayAdapter {
    ...
    public MyGridAdapter(@NonNull Context context, List<Date> dates, java.util.Calendar  currentDate, List<Events> events ) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView Event_Number = view.findViewById(R.id.eventsid);
