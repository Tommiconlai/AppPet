...
public class CustomCalendarView extends LinearLayout {
    ...
    SimpleDateFormat eventDateFormate = new SimpleDateFormat("dd-MM-yyyy", Locale.ENGLISH);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SetTime.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(addView.getContext(), androidx.appcompat.R.style.Base_Theme_AppCompat_Dialog,
